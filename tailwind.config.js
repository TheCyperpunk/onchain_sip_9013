  ...
  theme: {
    extend: {
      colors: {
        ...
        'border-hover': 'rgba(148, 163, 184, 0.2)', // slate-400 with opacity
        'border-focus': 'rgba(59, 130, 246, 0.5)', // blue-500 with opacity
      },
      fontFamily: {
        'heading': ['Inter', 'system-ui', 'sans-serif'],
        'body': ['Inter', 'system-ui', 'sans-serif'],
        'caption': ['Inter', 'system-ui', 'sans-serif'],
        'data': ['JetBrains Mono', 'Monaco', 'Consolas', 'monospace'],
      },
      fontSize: {
